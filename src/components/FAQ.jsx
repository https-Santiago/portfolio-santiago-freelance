...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Edición completa: armado, corrección de color, mejora de audio, música y subtítulos, por $20 USD (≈ $30.000 ARS) por video de hasta 1 minuto. Para videos más largos el precio se ajusta — escribime con la duración y te paso el número exacto. Extras como guion previo, motion graphics o multi-formato los charlamos aparte.',
  },
  {
